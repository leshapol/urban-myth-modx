<div
  class="two-images__block two-images__block_[[+_first:is=`1`:then=`first`]][[+_alt:is=`1`:then=`even`]]"
>
  <div class="two-images__image">
    <picture>
      <source
        type="image/webp"
        data-srcset="[[+image:phpthumbof=`w=700h=440&zc=1&f=webp`]]"
        srcset="
      ...
      <img
        ...
        data-srcset="[[+image:phpthumbof=`w=700h=440&zc=1`]]"
        alt="screen"
        width="700"
        height="440"
      />
