  ...
  <div class="footer__row">
    <div class="footer__column">
      <div class="footer__column-left">
        <a href="" class="footer__link_mobile button button_footer">
          BOOK CONSULTATION
        </a>
        <div class="footer__logo">
          <img
            src="/assets/theme/build/img/logo-white.png"
            srcset="
              /assets/theme/build/img/logo-white.png    1x,
              /assets/theme/build/img/logo-white@2x.png 2x
            "
            alt="Urban myth logo"
            width="232"
            height="121"
      ...
      <div class="footer__column-right">
        <a href="" class="footer__link button button_footer">
          BOOK CONSULTATION
        </a>
