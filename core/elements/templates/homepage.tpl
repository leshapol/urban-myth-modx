        ...
        <div class="hero__wrap">
            ...
            <picture>
              ...
              <source media="(min-width: 470px)"
                  ...
                  "
                      width="1920"
                      height="720" />
              <img src="/assets/theme/build/img/homepage/hero-img-mobile.jpg"
                   srcset="
          ...
          <div class="container">
            <div class="hero__body position_bottom position_left">
              ...
              <a href="#"
                 class="hero__button button button_long">
      ...
      <section class="kitchens">
        ...
        <div class="kitchens__body">
          <div class="kitchens__block">
            ...
            <div class="kitchens__image kitchens__border-radius absolute-image border-radius_right-bottom">
              <picture>
                <source media="(min-width: 470px)"
            ...
            <div class="kitchens__button-mobile">
              <a href="#"
                 class="button"> BOOK FREE CONSULTATION </a>
            </div>
          </div>
          ...
          <div class="kitchens__block">
            ...
            <div class="kitchens__image kitchens__border-radius absolute-image border-radius_left-top">
              <picture>
                <source media="(min-width: 470px)"
          ...
          <div class="kitchens__block">
            <div class="container">
              <div class="kitchens__text-block position_top position_left white-color">
                <h3 class="kitchens__title section-title">
      ...
      <section class="stay">
        <div class="container">
          <div class="stay__row">
            ...
            <a href="contact"
               class="stay__submit button _popup-link">contact us</a>
          </div>
        </div>
      </section>
      ...
      <section class="trustpilot">
        <div class="container">
          ...
          <div class="trustpilot-widget"
            ...
            <a href="https://www.trustpilot.com/review/urbanmyth.net"
               target="_blank"
      ...
      <section class="about">
        <div class="about__row">
          ...
          <div class="about__figure">
            <button class="about__arrow about__arrow_before"
                    type="button"></button>
            <button class="about__arrow about__arrow_after"
                    type="button"></button>
            <div class="about__images">
              <img class="about__image about__image_active"
            ...
            <div class="about__pag pag">
              <span data-num="0"
                    class="pag__item pag__item_active"></span>
              <span data-num="1"
                    class="pag__item"></span>
              <span data-num="2"
                    class="pag__item"></span>
            </div>
          </div>
