          ...
          <div class="row mx-md-5 pb-4">
            ...
            >
              <img
                ...
                height="88px"
              >
              <h2>We work with boutique developers, architects, and interior designers to deliver stunning bespoke
                kitchens and bedrooms for your development.</h2>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="container-fluid ">
            <div class="row mx-md-5 pb-4">
              <div class="col-md-12 text-center mx-auto text-dark">
                <h2 class="pb-4">We have a wealth of experience in delivering projects of all sizes and our unique
                  approach means you are fully supported throughout the process.</h2>
                <a
                  class="scroll p-5 text-dark"
        ...
        <div class="container-fluid my-5">
          <div class="row mx-md-5 pb-4 justify-content-between">
            ...
            <div class="col-md-8 ">
              ...
              <p>When you engage us at the beginning of your project, our experienced design team will profile your
                potential customers and propose an appealing design scheme that meets the needs of their lifestyle.
                Whether we are adding personality to a new build or complementing the features of a period property, our
                focus remains on creating a desirable space, on time and on budget.</p>
            </div>
          </div>

          <div class="row d-md-none">
            <div class="col-6">[[getImageList? &tvname=`Projects` &tpl=`more_project` &limit=`6`]]</div>
            <div class="col-6">[[getImageList? &tvname=`Projects` &tpl=`more_project` &offset=`6` &limit=`6`]]</div>
          </div>
          <div
  ...
  >
    ...
    <div class="container-fluid m-0 p-0">
      ...
      >
        ...
        <p>Over 30 years’ experience of working with homeowners, as well as developers, has given us a deep appreciation
          of how people want to live. It also keeps us up-to-date with the latest design trends. Our clear understanding
          of people’s needs and aspirations allows us to plan the most efficient and attractive spaces to suit your
          project.</p>
      </div>
      <div
        id="container1"
    ...
    <div class="container-fluid my-5">
      <div class="row mx-md-5 pb-4 ">
        <div class="col-md-6 order-md-1 order-2">
          ...
          <p>Our impressive showroom provides the perfect environment for a specification meeting. Here you can see,
            touch, and feel the quality of our products. And you can also meet the team – the people who make working
            with Urban Myth such a professional and pleasurable experience.</p>
        </div>
    ...
    <div class="container-fluid my-5 ">
      <div class="row mx-md-5 pb-4 pb-md-0">
        <div class="col-md-4 align-self-center">
          ...
          <p>One unique aspect of working with Urban Myth is our factory in Essex, where we produce our entire Urban
            Life range in-house. Our state-of-the-art machinery allows us to produce kitchens and bedrooms with maximum
            efficiency and total control over the manufacturing process, meaning we can remain competitive without
    ...
    <div class="container-fluid my-5 ">
      <div class="row mx-md-5 pb-4 pb-md-0">
        ...
        <div class="col-md-4  align-self-center order-1 order-md-2">
          ...
          <p>The success of any project depends on the bottom line. Urban Myth has excellent relationships with all the
            leading appliance brands and suppliers to the kitchen and bedroom industry. By working with Urban Myth, you
            have access to this network and can take advantage of our buying power and exclusive offers.</p>
        </div>
    ...
    <div class="container-fluid my-5 ">
      <div class="row mx-md-5 pb-md-4 align-items-center">
        <div class="col-md-5">
          ...
          <p>For us, getting your project completed on time is an essential requirement. Your own dedicated project
            manager will liaise with all the tradespeople on-site, throughout your build. They will make sure that
            everyone working on your project has a detailed site pack, outlining specific requirements, to ensure a
            seamless installation of our furniture and appliances.</p>
        </div>
      ...
      <div class="row mx-md-5 pb-md-0 align-items-center">
        ...
        <div class="col-md-4">
          <p>All our installers are CSCS approved and by using the same team from start to finish, we provide continuity
            throughout the project. Plus, our documented sign-off process guarantees that we meet your expectations at
            every stage of the installation.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container-fluid my-5 ">
      ...
      <div class="row mx-md-4 pb-md-4">
        <div class="col-md-4">
          ...
          <p>We leave our care and information booklet in every kitchen and bedroom we install, to answer most of the
            questions your customers might have about their new kitchen or bedroom furniture. At your request, we can
            further support your customers with our dedicated Aftercare Department. They can be on hand to assist your
            customers, should the need arise, taking one more thing off your mind.</p>
        </div>
        <div class="col-md-4 col-6">
          <img
    ...
    <div class="container-fluid py-5">
      ...
      <div class="row mx-md-5 pb-4">
        ...
        >
          ...
          <p>When you work with Urban Myth, we are with you every step of the way. Our service-led philosophy builds
            strong, trusting relationships with our customers, who use us time and again. We would welcome the
            opportunity to provide an indicative design and a quotation for a current or future project.</p>
          <p><strong>Please contact:</strong><br>robert@urbanmyth.net<br>020 8531 3413</p>
        </div>
