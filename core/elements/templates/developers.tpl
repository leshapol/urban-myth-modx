            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  <h1>Broom Hill</h1>
                  <h2>Bertroy Homes</h2>
                  <p>We were delighted to design, manufacture, and install the bespoke kitchens and fitted wardrobes for
                    both of these stunning four bedroom new build detached houses situated in the sought after
                    ‘Oaklands’ area of Welwyn, Hertfordshire.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  Seven unique and contemporary apartments with a clean modern design, fitted with our Urban Life
                  handleless kitchens to create a clean and modern design that appeals to the young professional home
                  buyer.
                  <div class="row pb-4">
                    <div class="col-6"><img
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  <h2>Regenta</h2>
                  <p>Two beautiful Victorian style houses in South Woodford Village feature a streamlined but
                    traditional kitchen design. To complement the traditional features of the properties the kitchens
                    feature our Urban Life Shaker cabinetry in Dust Grey.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  <h1>Bushett Rise</h1>
                  <h2>The Door</h2>
                  <p>The collection of seven contemporary countryside homes have been created with meticulous detail.
                    Each home complements each other whilst remaining wonderfully unique. From the Barn conversions to
                    the modern new houses, each home is full of character but share the same high speciﬁcation and
                    ﬁnishing throughout.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  <h1>The Drapery</h1>
                  <h2>Harding Homes</h2>
                  <p>This exciting development by Harding Homes revitalised one of Southend-on-Sea’s Edwardian
                    architectural icons, the former Brightwell’s Drapery and department store.</p>

                  <p>All 18 apartments feature Stone Grey units from the Urban Life range with fully integrated
                    appliances from the leading brands including Neff, Smeg and Blanco.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  <h1>Node Park</h1>
                  <h2>Taylor French</h2>
                  <p>Urban Myth has been involved with the transformation of this historic development since conception
                    and when designing and specifying the kitchen furniture and fittings for this development we ensured
                    that no detail was overlooked and the kitchens enhanced the character of the properties.</p>

                  <p>We have designed, manufactured and installed all 16 kitchens for three new build detached houses,
                    three renovated mews style coach houses and ten apartments.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  <h2>Durkan</h2>
                  <p>A collection of inspirational homes of true character. The Royal Military Academy has been fully
                    restored by Durkan Estates, with ten apartments offering a collection of inspirational homes of true
                    character, many of which are within the original Grade II* listed buildings and benefit from a
                    wealth of original features. Urban Myth &nbsp;designed stunning Anthracite Urban Myth kitchens to
                    contrast superbly with the original architectural gothic style.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  <h2>Etec Group</h2>
                  <p>A Luxury development of three stunning detached houses situated in close proximity of Epping
                    forest. Our client wanted a feeling of warmth and flow to the homes, our design achieves this with
                    generous walkthrough between the kitchen and dining areas whilst also providing an efficient cooking
                    area and a welcoming entertaining space.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  <h2>Chester Row</h2>
                  <p>Charles Baker Place is a development by Chester Row of nine family homes comprising an unusual
                    variety of houses. We are proud to have designed, manufactured and installed all nine kitchens in
                    this prestigious development. Many of the houses have natural light flooding in from the garden or
                    balconies and by using fresh and modern colour palettes for the kitchens we added to the spacious
                    feel of the open plan rooms.</p>
            ...
            <div class="container-fluid p-md-0">
              <div class="row m-0 align-items-center">
                <div class="col-md-5  p-0 py-5 ps-md-2 pe-md-5 offset-md-1   align-self-center">
                  ...
                  <h2>Morricom</h2>
                  <p>A unique collection of four architecturally designed contemporary townhouses in the heart of
                    Muswell Hill. We were delighted to be involved in this project to design and fit all four high
                    specification bespoke kitchens from our Urban Life range.</p>
        ...
        <div class="container-fluid py-5">
          ...
          <div class="row mx-md-5 pb-4">
            <div class="col-md-5">
              ...
              <p>
                <strong>Please contact:</strong><br />robert@urbanmyth.net<br />020 8531 3413
              </p>
            </div>
